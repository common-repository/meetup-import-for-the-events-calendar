...
<div class="xtmi_container">
    <div class="xtmi_row">
        <div class="xtmi-column-12 xtmi_well">
            <h3><?php esc_attr_e( 'Meetup Import Settings', 'xt-tec-meetup-import' ); ?></h3>
            <form method="post" enctype="multipart/form-data" id="xtmi_meetup_setting_form">
                <div class="xtmi_element">
                    <label class="xtmi_label"> <?php esc_attr_e( 'Meetup API key','xt-tec-meetup-import' ); ?> : </label>
                    ...
                    <span class="xtmi_small">
                        <?php _e( 'Insert your meetup.com API key you can get it from <a href="https://secure.meetup.com/meetup_api/key/" target="_blank">here</a>.', 'xt-tec-meetup-import' ); ?>
                    </span>
                </div>
                <div class="xtmi_element">
                    <label class="xtmi_label"> <?php esc_attr_e( 'Default status to use for imported events','xt-tec-meetup-import' ); ?> : </label>
                    <?php
                ...
                ?>
                <div class="xtmi_element">
                    <label class="xtmi_label"> <?php esc_attr_e( 'How do you want to import Meetup events','xt-tec-meetup-import' ); ?> : </label>

                    <input class="import_type" name="import_type" type="radio" value="cron" <?php if ( $import_type == 'cron' ) { echo 'checked="checked"'; } ?> />
                    <?php esc_html_e( 'Automatic', 'xt-tec-meetup-import' ); ?>
                    <input class="import_type" name="import_type" type="radio" value="manual" <?php if ( $import_type == 'manual') { echo 'checked="checked"'; } ?> />
                    <?php esc_html_e( 'Manual', 'xt-tec-meetup-import' ); ?>

                    <span class="xtmi_small">
                        <?php esc_html_e( 'Select "Automatic" if you want plugin check for events on meetup.com and import it.', 'xt-tec-meetup-import' ); ?><br />
                        <?php esc_html_e( 'Select "Manual" if you want to import event manually.', 'xt-tec-meetup-import' ); ?>
                    </span>
                </div>

                <div class="xtmi_element">
                    <label class="xtmi_label"> <?php esc_attr_e( 'Import Frequency', 'xt-tec-meetup-import' ); ?>: </label>
                    <?php
                    ...
                    <select name="cron_interval" >
                        <option value='hourly' <?php if ( $cron_interval == 'hourly' ) { echo 'selected="selected"'; } ?> >
                            <?php esc_html_e( 'Once Hourly','xt-tec-meetup-import' ); ?>
                        </option>
                        <option value='twicedaily' <?php if ( $cron_interval == 'twicedaily' ) { echo 'selected="selected"'; } ?>>
                            <?php esc_html_e( 'Twice Daily','xt-tec-meetup-import' ); ?>
                        </option>
                        <option value="daily" <?php if ( $cron_interval == 'daily' ) { echo 'selected="selected"'; } ?> >
                            <?php esc_html_e( 'Once Daily','xt-tec-meetup-import' ); ?>
                        </option>
                        <option value="weekly" <?php if ( $cron_interval == 'weekly' ) { echo 'selected="selected"'; } ?> >
                            <?php esc_html_e( 'Once Weekly','xt-tec-meetup-import' ); ?>
                        </option>
                        <option value="monthly" <?php if ( $cron_interval == 'monthly' ) { echo 'selected="selected"'; } ?> >
                            <?php esc_html_e( 'Once a Month','xt-tec-meetup-import' ); ?>
                        </option>
                    </select>
                    <span class="xtmi_small">
                        <?php esc_html_e( 'Applicable only if you had select "Automatic" import type.', 'xt-tec-meetup-import' ); ?><br />
                    </span>
                </div>
                ...
                ?>
                <div class="xtmi_element">
                    <label class="xtmi_label"> <?php esc_attr_e( 'Update imported Event ?', 'xt-tec-meetup-import' ); ?> : </label>

                    <input class="update_events" name="update_events" type="radio" value="yes" <?php if ( $update_events == 'yes' ) { echo 'checked="checked"'; } ?> />
                    <?php esc_html_e( 'Yes, Update imported events durring automatic syncronize.', 'xt-tec-meetup-import' ); ?><br />
                    <input class="update_events" name="update_events" type="radio" value="no" <?php if( $update_events == 'no' ){ echo 'checked="checked"'; } ?> />
                    <?php esc_html_e( 'No, Leave imported events unmodified.', 'xt-tec-meetup-import' ); ?>
                </div>
                ...
                <div class="xtmi_element">
                    ...
                    <input type="submit" class="button-primary xtmi_submit_button" style=""  value="<?php esc_attr_e( 'Save Settings', 'xt-tec-meetup-import' ); ?>" />
                </div>
